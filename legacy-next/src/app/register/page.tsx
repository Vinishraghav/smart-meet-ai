...
import { Video, Mail, Lock, User, ArrowRight, Github } from 'lucide-react';
                ...
                <div className="w-full max-w-md">
                    <div className="glass-panel p-8 space-y-8">
                        <div className="text-center space-y-2">
                            ...
                            <p className="text-slate-400">Join the future of intelligent meetings</p>
                        </div>
                        ...
                        <form onSubmit={handleRegister} className="space-y-4">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-800/50 border border-slate-700 rounded-xl py-3 pl-10 pr-4 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all font-medium"
                                    required
                                />
                            </div>
                            <div className="relative">
